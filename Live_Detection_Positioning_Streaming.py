...
# Makinng connection between the Rasspberry Pi and the IoT car main ECU using Py Serial
...
# cred = credentials.Certificate('C:/Users/Seif/Downloads/iotcar-3117d-firebase-adminsdk-********.json')
# firebase_admin.initialize_app(cred, {
#     'databaseURL': 'https://iotcar ************* firebaseio.com/'
# })
...
while True:
    ...
    for i in range(boxes.size(0)):
        ...
        cv2.rectangle(orig_image, (int(box[0]), int(box[1])), (int(box[2]), int(box[3])), (0,255,255), 8)
        ...
        cv2.putText(orig_image, pos, (int(box[2]) - text_size[0] - 10, int(box[1]) + 20),
